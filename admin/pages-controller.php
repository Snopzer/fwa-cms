...
if ($_POST['action'] == 'add') {
    ...
    $addPage = $conn->query("INSERT INTO r_page (title,meta_description,meta_keywords,page_heading,page_description) VALUES ('" . $title . "','" . $meta_description . "','" . $meta_keywords . "','" . $page_heading . "','" . $page_description . "')") ;
