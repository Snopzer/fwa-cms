<nav class="navbar-default navbar-static-top" role="navigation">
    <div class="navbar-header">
        ...
        <h1> <a class="navbar-brand" href="home.php">Learning Curve</a></h1>         
    </div>
        ...
        <div class="full-left">
            ...
            <section class="full-top">
                <form class=" navbar-left-right" action="search.php?type=search" method="POST">
                    <input type="text" name="search" id="search" onblur="if (this.value == '') {
                                this.value = 'Search...';
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
				...
				<li class="">
                    ...
                    <li><a href="participant.php" 	class=" hvr-bounce-to-right"><i class="fa fa-desktop nav_icon"></i><span class="nav-label">Participants</span> </a></li>
                    <li><a href="country.php" 	class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i><span class="nav-label">Countries</span> </a></li>
                    <li><a href="city.php" 	class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i><span class="nav-label">City's</span> </a></li>
                    <li><a href="site.php" class=" hvr-bounce-to-right"><i class="fa fa-cog nav_icon"></i><span class="nav-label">Site details</span> </a></li>
                    <li><a href="skill.php" class=" hvr-bounce-to-right"><i class="fa fa-cog nav_icon"></i><span class="nav-label">Skills</span> </a></li>
