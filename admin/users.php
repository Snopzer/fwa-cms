<?php
	...
	$userQuery = mysql_query("SELECT * FROM r_user order by id_user desc")or die(mysql_error());
	...
	$userList = mysql_query("SELECT * FROM r_user order by id_user desc limit $page1,5")or die(mysql_error());
									...
									<?php
										if (mysql_num_rows($userList) > 0) {
											...
											<tr class="table-row">
												...
												<!--<td class="march"><h6><?php echo $user["department"] ?></h6></td>-->
